<div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/createMatricula.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Inscripcion</h4>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="usuarioid " class="col-sm-3 control-label">Nombre Usuario: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					<select name="usuarioid" id="usuarioid" class="form-control">
						<?php $query=mysqli_query($connect,"SELECT USUARIOID, NOMBREUSU FROM usuario");?>
						<?php 
						while ($especies = mysqli_fetch_array($query)){ ?>
						<option value=" <?php echo $especies['USUARIOID'];?> "> <?php echo $especies['NOMBREUSU'];?></option><br>
						<?php    
						// $connect->close();
						}?>
					</select>
	        ...
	        <div class="form-group">
	        	<label for="reunionid " class="col-sm-3 control-label">Matriculado en: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					<select name="reunionid" id="reunionid" class="form-control">
						<?php $query=mysqli_query($connect,"SELECT TEMAREU, REUNIONID FROM reunion WHERE TIPOREUNIONID = 1");?>
						<?php 
						while ($especies = mysqli_fetch_array($query)){ ?>
						<option value=" <?php echo $especies['REUNIONID'];?> "> <?php echo $especies['TEMAREU'];?></option><br>
						<?php    
						// $connect->close();
						}?>
					</select>
