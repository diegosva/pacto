...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2021 a las 01:04:17
...
CREATE TABLE `asistencia` (
  ...
  `MATRICULADOASIS` tinyint(1) NOT NULL
...
(2, 'asociacion2', 'Ponceano', 'Los cipreces', 'Cotocollao', NULL, 1);
...
(1, 2, NULL, 1, 1, '2021-09-24', '12:28:00', 'Apertura plataformas', '2021-09-24 00:00:00', '17:28:00', 'ordinaria', 'actas', NULL, NULL),
(2, 2, NULL, NULL, 1, '2021-09-23', '17:03:00', 'Prueba reunion', NULL, NULL, 'Ordinaria', 'a', NULL, NULL),
(4, 2, NULL, 1, 1, '2021-09-25', '15:10:00', 'Prueba Aso 2', NULL, '18:07:00', 'Extraordinaria', 'acta', NULL, NULL);
...
--
ALTER TABLE `pertenecen`
  MODIFY `PERTENECENID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `reunion`
  MODIFY `REUNIONID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
