...
// var asistencia = $(this).data('id');
// var asistencia = $(this).attr('data-id');
// var asistencia = $("#asistencia").data("id");
...
$(document).ready(function() {
	...
	manageBrandTable = $("#manageBrandTable").DataTable({
		'ajax': 'php_action/fetchAsistencia.php',
		'order': []		
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		var fechaAsis = $("#fechaAsis").val();
		var asistenciaid = $("#asistenciaid").val();

		if(fechaAsis == "") {
			$("#fechaAsis").after('<p class="text-danger">Este campo es obligatorio</p>');
			$('#fechaAsis').closest('.form-group').addClass('has-error');
		} else {
			// remov error text field
			$("#fechaAsis").find('.text-danger').remove();
			// success out for form 
			$("#fechaAsis").closest('.form-group').addClass('has-success');	  	
		}

		if(asistenciaid == "") {
			$("#asistenciaid").after('<p class="text-danger">Este campo es obligatorio</p>');

			$('#asistenciaid').closest('.form-group').addClass('has-error');
		} else {
			// remov error text field
			$("#asistenciaid").find('.text-danger').remove();
			// success out for form 
			$("#asistenciaid").closest('.form-group').addClass('has-success');	  	
		}

		if(fechaAsis && asistenciaid) {
			var form = $(this);
			// button loading
...
function editAsistencia(entidadid = null) {
	if(entidadid) {
