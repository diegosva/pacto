...
var manageProductSocioTable;

$(document).ready(function () {
    // top nav bar 
    $('#navProduct').addClass('active');
    // manage product data table
    manageProductSocioTable = $('#manageProductSocioTable').DataTable({
        'ajax': 'php_action/fetchSocioProduct.php',
        'order': [],
        "scrollX": true,
    });
            ...
            $.ajax({
                ...
                success:function(response) {
                    ...
                    if(response.success == true) {
                        ...
                        manageProductSocioTable.ajax.reload(null, false);						
	...
	$.ajax({
		...
		success:function(response) {			
			...
			$("#removeProductBtn").unbind('click').bind('click', function() {
				...
				$.ajax({
					url: 'php_action/removeSocioProduct.php',
					type: 'post',
					data: {productId: productId},
					dataType: 'json',
					success:function(response) {
