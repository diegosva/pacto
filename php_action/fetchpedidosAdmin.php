...
PVPPRODUCT,
STOCKPRODUCT, 
LUGARCONSUMO.NOMBRELUCO 
FROM PRODUCTO,CATEGORIAPRODUCTO, LUGARCONSUMO, PERTENECEN, ASOCIACION, USUARIO 
WHERE PRODUCTO.CATEGORIAID = CATEGORIAPRODUCTO.CATEGORIAID 
AND PRODUCTO.LUGARCONSUMOID = LUGARCONSUMO.LUGARCONSUMOID 
