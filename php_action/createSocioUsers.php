...
if($_POST) {	
	...
	$sql = "INSERT INTO USUARIO (NOMBREUSU, ROLID,EMAILUSU,TELCUSU,TELCELUSU,CONTRAUSU,DIRUSU,NOMBREAPEUSU,STATUSUSU) 
	VALUES ('$NOMBREUSU', $ROLID,'$EMAILUSU', '$TELCUSU','$TELCELUSU', '$CONTRAUSU', ' $DIRUSU', '$NOMBREAPEUSU',$STATUSUSU)";
