...
<body>
  ...
  <nav class="navbar navbar-default navbar-static-top">
    <div class="container">
      ...
      <div class="col1">
        <h4 style="font-weight: bold; text-transform:uppercase"> <i class="fas fa-user-cog"></i> Bienvenido <?php echo $USUNOM ?></h4>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="navUsers"><a href="users.php"><i class="fas fa-users"></i> Usuarios</a></li>

          <li id="navAssociations"><a href="associations.php"><i class="far fa-handshake"></i> Asociaciones</a></li>
